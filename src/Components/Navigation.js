...
function Navigation() {
  return (
    <div className="nav-bar">
      ...
      <Link to="/hakkimizda" style={{ textDecoration: "none", color: "#fff" }}>
        <p className="nav-bar-text">Hakkımızda</p>
      </Link>
      <Link to="/gonulluol" style={{ textDecoration: "none", color: "#fff" }}>
        <p className="nav-bar-text">Gönüllü Ol</p>
      </Link>
      <Link to="/etkinlik" style={{ textDecoration: "none", color: "#fff" }}>
        <p className="nav-bar-text">Etkinlik Takvimi</p>
      </Link>
      <Link to="/iletisim" style={{ textDecoration: "none", color: "#fff" }}>
